...
Description: A WordPress plugin which adds a multi-level CSS based dropdown/flyout/slider menu to your WordPress blog. Visit the <a href="http://pixopoint.com/multi-level-navigation/">WP Multi-level Navigation Plugin page</a> for more information about the plugin.
...
define( 'MULTILEVELNAVIGATION_VERSION', '2.3.5' );
define( 'MULTILEVELNAVIGATION_AD', "\n<!-- Multi-level Navigation Plugin v" . MULTILEVELNAVIGATION_VERSION ." by PixoPoint Web Development ... http://pixopoint.com/multi-level-navigation/ -->\n" );
