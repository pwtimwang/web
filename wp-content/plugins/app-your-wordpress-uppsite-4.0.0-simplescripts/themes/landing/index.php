...
<div class="main-wrapper">
    <div id="top_container">
        ...
        <div class="button_image_wrapper">
            <a href='<?php echo $native_url?>'><img src='<? echo $base_dir ?>/images/button1.png'/></a>
        </div>
        <?php endif; ?>
        <?php if (mysiteapp_should_show_webapp()): ?>
        <div class="button_image_wrapper">
            <a href='<?php echo $next_url ?>webapp' onclick='return btn_selected(this);'><img src='<? echo $base_dir ?>/images/button2.png'/></a>
        </div>
        <?php endif; ?>
        <div class="button_image_wrapper">
            <a href='<?php echo $next_url ?>normal' onclick='return btn_selected(this);'><img src='<? echo $base_dir ?>/images/button3.png'/></a>
        </div>
    ...
    <div id="bottom_container">
        <img src="<? echo $base_dir ?>/images/uppsite_logo.png"/>
    </div>
</div>
<script type="text/javascript">
