...
/**
 * $Id: hacklogra.class.php 571281 2012-07-12 14:54:00Z ihacklog $
 * $Revision: 571281 $
...
class hacklogra
{
	...
	public function __construct()
	{
		...
		//替换掉文章中的image
		add_filter('the_content', array(__CLASS__, 'replace_imgurl_inPost'),  -999);
...
// Set the permission constants if not already set.
	...
	{
		if (strpos($file, self::$local_basepath) !== 0)
		{
			$localfile = self::$local_basepath . '/' . $file;
...
//		 Adds my help tab when my admin page loads
	...
	public static function plugin_options()
	{
		...
		/**
	 * the hook is in function 
	 * @static
	 * @param $html
	 * @return mixed
	 */
	public static function replace_imgurl_inPost($html)
	{
		if(is_single())
		{
			$html = str_replace(self::$local_baseurl, self::$remote_baseurl, $html);
